...
## **Where Can Experiencial Learning Be Obtained?**
...
|-----|-------------|-------------|-----------|
|**Company**|Intellifi Corporation (formerly Delta 360 Inc.)|Sun Life|Bank of Canada|
|**Salary**|$60,000-$95,000|$80000|$88505-$110630|
|**City**|Markham, Ontario|North York, Ontario|Toronto, Ontario|
|**Job Description**|As the Software Developer, you will have a blend of responsibilities that will require a hands-on approach and result in being a key contributor to the development of software. Intellifi believes in achieving the highest possible quality, maintain our reputation of ease of use, performance, and reliability. If you’re passionate about driving innovative solutions this role is for you!|We are currently seeking a Software Engineer to join a new agile team that will develop, support, and analyze technical solutions within the Canadian IT Platforms and Engineering team. The successful candidate is a team player with excellent technical and problem-solving skills, is aware of industry trends, questions the status quo and can identify and propose alternatives. Come join us as we continue to intensify the focus on our digital journey, building APIs and improving our client experience.|We are seeking an innovative and skilled web portal developer to join our Retail Payments Supervision team! We are a collaborative and diverse team within ITS with the mission to carry out the roadmap of an effective regulatory IT platform to meet the requirements of the Bank of Canada’s role in supervising payment service providers (PSPs).|
|**Additional Skills**|Analysis, design, development, and deployment of large-scale enterprise application systems.|A penchant for creating re-usable components and identifying opportunities for re-use.
